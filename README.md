...
Generally there are many way to reach the JS Engine context from Java. One may use [<code>j2v8 bindings</code>](https://github.com/eclipsesource/J2V8) for this purpose and get such a simolified excerpt of V8 context extending with j2v8 bindings:
```
dependencies {
    ...
